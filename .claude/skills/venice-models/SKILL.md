...
Crypto RPC pricing is **not** in `/models` — it's tier × chain multipliers on `/crypto/rpc/{network}` (see [`venice-crypto-rpc`](https://github.com/veniceai/skills/blob/main/skills/venice-crypto-rpc/SKILL.md)).

...
- `402` — insufficient balance. Bearer → `{ error: "INSUFFICIENT_BALANCE" }`. x402 → `PAYMENT_REQUIRED` with `topUpInstructions` and `siwxChallenge` (see [`venice-x402`](https://github.com/veniceai/skills/blob/main/skills/venice-x402/SKILL.md)).
- `429` — rate-limited.

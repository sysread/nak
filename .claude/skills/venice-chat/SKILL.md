...
|---|---|---|---|
| `character_slug` | string | — | Apply a published Venice character. Slug is the "Public ID" on the character page. See [`venice-characters`](https://github.com/veniceai/skills/blob/main/skills/venice-characters/SKILL.md). |

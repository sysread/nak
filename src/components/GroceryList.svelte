<script lang="ts">
  /*
   * Sidebar grocery list. Shown in the left drawer when the Groceries
   * tab is active - and unlike the other tabs, the list IS the
   * feature: there is no per-item main-panel detail, so add / edit /
   * check-off all happen inline here (the surface is designed for a
   * phone at the store, where the drawer is the whole screen).
   *

<script lang="ts">
  /*
   * Scanner — a K.I.T.T.-style back-and-forth pulser. Five dots sized from
   * `.` to `O` and back, sweeping left-to-right and then right-to-left on
   * a loop. Used anywhere the app has a short-lived "something's
   * happening, no useful progress signal yet" moment — the composer's
   * pre-first-token gap, the auto-title generation, etc.
   *

...
>
  <!-- Thought-cloud line icon rather than a 💭 emoji: the emoji renders
  ...
  <svg class="model-picker-model-icon" width="18" height="18" viewBox="0 0 24 24"
    ...
    <path d="M8 13a4 4 0 0 1-.8-7.9 4.5 4.5 0 0 1 8.5-1 3.5 3.5 0 0 1 .8 6.9" />
    <path d="M8 13h8.5a2.5 2.5 0 0 1 0 5H8a2.5 2.5 0 0 1 0-5z" />
    <circle cx="6.5" cy="21" r="1" />
    <circle cx="10" cy="22.5" r="0.5" />
  </svg>

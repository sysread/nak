...
export const recordLinkCreateSchema = {
  ...
  description:
    'Link one record to another with a short relationship label. The ' +
    'link is DIRECTED (from -> to): create it from the newer/derived ' +
    'record to the one it builds on. Re-linking the same pair updates ' +

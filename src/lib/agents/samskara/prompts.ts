 ...
 */
export const ASSIMILATOR_PROMPT = `You are summarising one round of a conversation between a user and
 ...
 */
export const RELATOR_PROMPT = `You are comparing two snapshots of past conversations. Each snapshot
 ...
 */
export const MINTER_PROMPT = `You are minting a "samskara" - a short, predictive claim about a
 ...
 */
export const REACTION_PROMPT = `You are scoring how a user reacted to an AI assistant turn that was
 ...
 */
export const COMPOUND_SUMMARY_PROMPT = `You will receive a list of samskaras - short predictive claims a

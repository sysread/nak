...
export function buildJournalPrompt(args: BuildPromptArgs): string {
  ...
  lines.push(
    ...
    "  roles. Only what the USER wrote belongs to them - their",
    '  statements, questions, reactions, reframings. Assistant',
    '  explanations, definitions, factual elaborations, and',
    '  framings the assistant supplied are NOT the user\'s; if the',
    "  assistant introduced a fact, the user did not bring it.",
    "  Treat assistant turns as context for what the user",
    '  REACTED to, not as material to attribute. "User noticed X"',
    "  is fair when the user noticed X; it is not fair when the",
    "  assistant explained X and the user said \"interesting\".",
    '',
    '## Output format',
    '',

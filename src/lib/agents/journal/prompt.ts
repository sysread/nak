...
export function buildJournalPrompt(args: BuildPromptArgs): string {
  ...
  lines.push(
    ...
    'The single most useful question to keep in mind: WHAT DID THE',
    'USER LEARN ABOUT THEMSELVES in this conversation? Most worthy',
    'entries answer that even when the user did not phrase it as a',
    'realisation. Look also for:',
...
export function buildJournalRegeneratePrompt(
  ...
  lines.push(
    ...
    'topic to summarise. The single most useful question to keep in',
    'mind: WHAT DID THE USER LEARN ABOUT THEMSELVES in this',
    'conversation?',
    '',

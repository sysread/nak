 ...
 * Samskara group is extracted (./supabase/samskara.ts); the remaining
 * groups still carry their implementations inline and should follow
 * the same pattern when touched substantially.
 */
